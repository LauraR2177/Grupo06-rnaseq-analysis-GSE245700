...
Este repositorio contiene el análisis bioinformático de la serie **GSE245700**. El objetivo es estudiar cómo cambia la expresión de los genes en células de cáncer de pulmón (A549) cuando se les aplica un tratamiento específico.
